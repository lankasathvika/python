...
const sendMessage = async (e: React.FormEvent) => {
  ...
  try {
    ...
    if (receiverSnapshot.exists()) {
      ...
      // ✅ Send notification if FCM token exists and user is offline
      if (receiverFcmToken && !isOnline) {
        await sendNotification(receiverFcmToken, user.displayName || 'Anonymous', newMessage);
      }
    }
  } catch (error) {
...
// ✅ Function to Send Notification via Backend API
